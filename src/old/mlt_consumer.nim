...
type
  mlt_consumer_s* {.bycopy.} = object
    parent*: mlt_service_s     ## * A consumer is a service.
    ## * Start the consumer to pull frames (virtual function).
    ##
    ##  \param mlt_consumer a consumer
    ##  \return true if there was an error
    ##
    start*: proc (a1: mlt_consumer): cint {.cdecl.} ## * Stop the consumer (virtual function).
                                              ##
                                              ##  \param mlt_consumer a consumer
                                              ##  \return true if there was an error
                                              ##
    stop*: proc (a1: mlt_consumer): cint {.cdecl.} ## * Get whether the consumer is running or stopped (virtual function).
                                             ##
                                             ##  \param mlt_consumer a consumer
                                             ##  \return true if the consumer is stopped
                                             ##
    is_stopped*: proc (a1: mlt_consumer): cint {.cdecl.} ## * Purge the consumer of buffered data (virtual function).
                                                   ##
                                                   ##  \param mlt_consumer a consumer
                                                   ##
    purge*: proc (a1: mlt_consumer) {.cdecl.} ## * The destructor virtual function
                                         ##
                                         ##  \param mlt_consumer a consumer
                                         ##
...
proc mlt_consumer_init*(self: mlt_consumer; child: pointer; profile: mlt_profile): cint {.
    cdecl, importc: "mlt_consumer_init", dynlib: libName.}
proc mlt_consumer_new*(profile: mlt_profile): mlt_consumer {.cdecl,
    importc: "mlt_consumer_new", dynlib: libName.}
proc mlt_consumer_service*(self: mlt_consumer): mlt_service {.cdecl,
    importc: "mlt_consumer_service", dynlib: libName.}
proc mlt_consumer_properties*(self: mlt_consumer): mlt_properties {.cdecl,
    importc: "mlt_consumer_properties", dynlib: libName.}
proc mlt_consumer_connect*(self: mlt_consumer; producer: mlt_service): cint {.cdecl,
    importc: "mlt_consumer_connect", dynlib: libName.}
proc mlt_consumer_start*(self: mlt_consumer): cint {.cdecl,
    importc: "mlt_consumer_start", dynlib: libName.}
proc mlt_consumer_purge*(self: mlt_consumer) {.cdecl, importc: "mlt_consumer_purge",
    dynlib: libName.}
proc mlt_consumer_put_frame*(self: mlt_consumer; frame: mlt_frame): cint {.cdecl,
    importc: "mlt_consumer_put_frame", dynlib: libName.}
proc mlt_consumer_get_frame*(self: mlt_consumer): mlt_frame {.cdecl,
    importc: "mlt_consumer_get_frame", dynlib: libName.}
proc mlt_consumer_rt_frame*(self: mlt_consumer): mlt_frame {.cdecl,
    importc: "mlt_consumer_rt_frame", dynlib: libName.}
proc mlt_consumer_stop*(self: mlt_consumer): cint {.cdecl,
    importc: "mlt_consumer_stop", dynlib: libName.}
proc mlt_consumer_is_stopped*(self: mlt_consumer): cint {.cdecl,
    importc: "mlt_consumer_is_stopped", dynlib: libName.}
proc mlt_consumer_stopped*(self: mlt_consumer) {.cdecl,
    importc: "mlt_consumer_stopped", dynlib: libName.}
proc mlt_consumer_close*(a1: mlt_consumer) {.cdecl, importc: "mlt_consumer_close",
    dynlib: libName.}
proc mlt_consumer_position*(a1: mlt_consumer): mlt_position {.cdecl,
    importc: "mlt_consumer_position", dynlib: libName.}